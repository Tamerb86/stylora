...
export default function POS() {
  ...
  const [zettlePurchaseUUID, setZettlePurchaseUUID] = useState<string | null>(
    null
  );
    ...
    try {
      ...
      if (paymentMethod === "cash") {
        ...
        try {
          ...
          setPaymentInstructions(
            zettleResult.message || "Betaling sendt til PayPal Reader..."
          );
          setIsProcessingPayment(false);

          // Show info toast
          toast.info(
            "Betaling sendt til PayPal Reader. Sjekk Reader-skjermen."
          );
