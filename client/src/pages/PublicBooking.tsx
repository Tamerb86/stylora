...
export default function PublicBooking() {
  ...
  const subdomain = useMemo(() => {
    ...
    if (tenantIdParam) {
      console.log(
        "[Booking] Using tenantId from URL parameter:",
        tenantIdParam
      );
  ...
  const { data: paymentSettings } = (
    trpc as any
  ).paymentSettings.getPublic.useQuery(
    { tenantId: TENANT_ID },
    { enabled: !!TENANT_ID }
  );
              ...
              {currentStep === "employee" && (
                <div className="space-y-8 fade-in">
                  <Button
                    variant="ghost"
                    onClick={goBack}
                    className="mb-4 hover:bg-gradient-to-r hover:from-gray-100 hover:to-gray-200 transition-all duration-300 hover:scale-105"
                  >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {paymentSettings?.payAtSalonEnabled && (
                          <Card
                            ...
                            onClick={() =>
                              setPaymentMethod("pay_at_salon" as any)
                            }
                          >
                            <CardContent className="p-6">
                              <div className="flex items-center gap-4">
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                        <p className="text-sm text-blue-900">
                          <strong>Bekreftelse sendt!</strong> Du vil motta en
                          bekreftelse på SMS/e-post med alle detaljene.
                        </p>
                      </div>
