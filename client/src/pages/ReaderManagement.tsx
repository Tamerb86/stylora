...
export default function ReaderManagement() {
      ...
      try {
        ...
        const terminal = StripeTerminal.create({
          ...
          onUnexpectedReaderDisconnect: () => {
            toast.error("Kortleseren koblet fra uventet", {
        ...
        toast.error("Kunne ikke initialisere kortsystem", {
  ...
  const discoverReaders = async () => {
    ...
    try {
      ...
      if (discoverResult.error) {
        ...
        toast.error("Kunne ikke søke etter kortlesere", {
        ...
        if (discoverResult.discoveredReaders.length === 0) {
          toast.info("Ingen kortlesere funnet", {
            description: "Sjekk at leseren er på og koblet til nettverket",
          });
        } else {
    ...
    try {
      ...
      if (connectResult.error) {
        ...
        toast.success("Koblet til leseren", {
          description: `Tilkoblet: ${reader.label || reader.id}`,
        });
      }
    } catch (error: any) {
  ...
  const disconnectReader = async () => {
    ...
    try {
      ...
      setConnectedReader(null);
      toast.success("Koblet fra leseren");
    } catch (error: any) {
      ...
      <div className="container mx-auto py-8">
            ...
            {connectedReader ? (
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Ingen kortleser tilkoblet for øyeblikket
                  </p>
                </div>
              </div>
            )}
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Søk etter tilgjengelige kortlesere på nettverket
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button
